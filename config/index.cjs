const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxfee9665cb74e369c',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '832a427da482e08d1a960023bc8dbee6',
  ...
  TIAN_API: {
    ...
    key: '832a427da482e08d1a960023bc8dbee6',
  ...
  USERS: [
    {
      ...
      id: 'oCr0j52BFBNYxwptDzzfca27mb0E',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
      useTemplateId: 'm39t1QL7Q_EdvjYDLXOOW2D4_uySu1es_p4VULdzdIo',
      // 所在省份或城市，也可以不填
      province: '辽宁',
      // 所在城市或县区
      city: '大连',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '1999', date: '09-15',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '节日', name: '被搭讪纪念日', year: '2022', date: '03-22',
        }
      ],
